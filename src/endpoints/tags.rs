use crate::{
    ...
    types::types_tags::{
        GetTagByIdArgs, GetTagByIdResponse, GetTagBySlugArgs, GetTagBySlugResponse, ListTagsArgs,
        ListTagsResponse,
    },
};
...
impl GammaClient {
    ...
    pub async fn get_related_tags_by_id(&self) {}
    pub async fn get_related_tags_by_slug(&self) {}
}
...
mod tests {
    use crate::{
        GammaClient,
        types::types_tags::{GetTagByIdArgs, GetTagBySlugArgs, ListTagsArgs},
    };
